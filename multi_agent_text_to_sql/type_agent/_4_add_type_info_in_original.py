...
REFERENCE_DATASET_PATH = BASE_DIR / "_3_dataset_with_sparql_types.json"
OUTPUT_DATASET_PATH = BASE_DIR / "_4_source_dataset_with_columns_by_type.json"

SOURCE_ID_FIELD = "_id"
REFERENCE_ID_FIELD = "question_id"
REFERENCE_VALUE_FIELD = "columns_by_type"
OUTPUT_FIELD = "columns_by_type"
...
def add_field_by_id_match(
	...
	for row in source_rows:
		...
		if row_id and row_id in lookup:
